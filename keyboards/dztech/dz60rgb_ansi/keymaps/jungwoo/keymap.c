...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_BL] = LAYOUT_60_ansi(
		...
		KC_LCTL, KC_LALT, KC_LGUI, 				GSpace, 		KC_RALT, MO(1), TG(3), KC_RCTL),
	/*
	[_BL] = LAYOUT_60_ansi(
		KC_GESC,     KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_6,   KC_7,   KC_8,   KC_9,   KC_0,   KC_MINS, KC_EQL, KC_BSPC, \
		LTap,   KC_Q,   KC_W,   KC_E,   KC_R,   KC_T,   KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,   KC_LBRC, KC_RBRC,KC_BSLS, \
	...
	*/
	...
	[1] = LAYOUT_60_ansi(
		...
		KC_TRNS, KC_LEFT, KC_DOWN, KC_RGHT, LCTL(KC_F),  CtrG, KC_PGUP, KC_LEFT, KC_DOWN, KC_RGHT, KC_NO, KC_NO, KC_NO, \
		_______, LCTL(KC_Z), LCTL(KC_X), LCTL(KC_C), LCTL(KC_V),  CtrB, KC_PGDN, KC_NO, RGB_TOG, RGB_RMOD, RGB_MOD, MO(2), \
	...
	[3] = LAYOUT_60_ansi(
		...
		KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, \
		KC_LCTL, KC_LALT, KC_LGUI, 				KC_SPC, 		KC_RALT, MO(4), KC_TRNS, KC_RCTL),
	[4] = LAYOUT_60_ansi(
