...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_BL] = LAYOUT_ANSI(
		...
		KC_LCTL, KC_LALT, KC_LGUI, 				KC_SPC, 		KC_HAEN, MO(1), TG(3), KC_RCTL),
	/*
	[_BL] = LAYOUT_60_ansi(
		KC_GESC,     KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_6,   KC_7,   KC_8,   KC_9,   KC_0,   KC_MINS, KC_EQL, KC_BSPC, \
		LTap,   KC_Q,   KC_W,   KC_E,   KC_R,   KC_T,   KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,   KC_LBRC, KC_RBRC,KC_BSLS, \
	...
	*/
	...
	[1] = LAYOUT_ANSI(
		...
		KC_CAPS, KC_LALT, KC_UP, LCTL(KC_W), KC_WREF, LCTL(KC_T), KC_NO, KC_HOME, KC_UP, KC_END, KC_NO, KC_VOLD, KC_VOLU, KC_NO, \
		KC_TRNS, KC_LEFT, KC_DOWN, KC_RGHT, LCTL(KC_F), KC_NO, KC_PGUP, KC_LEFT, KC_DOWN, KC_RGHT, KC_NO, KC_NO, KC_NO, \
		KC_NO, LCTL(KC_Z), LCTL(KC_X), LCTL(KC_C), LCTL(KC_V), KC_NO, KC_PGDN, KC_NO, RGB_TOG, RGB_RMOD, RGB_MOD, MO(2), \
